  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-1/4 right-1/4 w-[600px] h-[600px] bg-rapid-500/5 rounded-full blur-3xl" />
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <Card className="border-border/50 bg-card/80 backdrop-blur-sm">
          <CardHeader>
            ...
            <CardDescription>Start analyzing and optimizing for free</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <p className="text-center text-sm text-muted-foreground">
              ...
              <Link href="/auth/signin" className="text-rapid-400 hover:underline">
                Sign in
              </Link>
            </p>
